...
function test_idkey(t)
    ...
    checkLex(t, "eol", {"eol",KEYx}, "keyword: eol")
    ...
    checkLex(t, "inputnum", {"inputnum",KEYx}, "keyword: inputnum")
    checkLex(t, "not", {"not",KEYx}, "keyword: not")
    checkLex(t, "or", {"or",KEYx}, "keyword: or")
    checkLex(t, "output", {"output",KEYx}, "keyword: output")
    ...
    checkLex(t, "output2", {"output2",IDx}, "keyword+digit")
    ...
    checkLex(t, "_output",{"_output",IDx}, "_ + keyword")
    ...
    checkLex(t, "read",{"read",IDx}, "former keyword: read")
...
function test_program(t)
    ...
    checkLex(t, "#!./tenrec.lua\n"..
            ...
            {"output",KEYx,"(",PUNCTx,"\"Type a number: \"",STRLITx,
             ")",PUNCTx,";",PUNCTx,"n",IDx,"=",OPx,"inputnum",KEYx,
             "(",PUNCTx,")",PUNCTx,";",PUNCTx,"output",KEYx,"(",PUNCTx,
             "'You entered: '",STRLITx,",",PUNCTx,"n",IDx,",",PUNCTx,
             "eol",KEYx,")",PUNCTx,";",PUNCTx},
             "Very short program with shebang line")
    ...
    checkLex(t, "a_1[0]=1;"..
                "a_1[a_1[0]]=a_1[0]+2;"..
                "_b2b=a_1[0]+3;"..
                "if(_b2b==6){output(\"good\",eol);}"..
                "elseif(_b2b>6){output(\"too high\",eol);}"..
                "else{output(\"too low\",eol);}",
             {"a_1",IDx,"[",OPx,"0",NUMLITx,"]",OPx,"=",
              ...
              "if",KEYx,"(",PUNCTx,"_b2b",IDx,"==",OPx,"6",NUMLITx,
                ")",PUNCTx,"{",PUNCTx,
              "output",KEYx,"(",PUNCTx,"\"good\"",STRLITx,",",PUNCTx,
                "eol",KEYx,")",PUNCTx,";",PUNCTx,"}",PUNCTx,
              "elseif",KEYx,"(",PUNCTx,"_b2b",IDx,">",OPx,"6",NUMLITx,
                ")",PUNCTx,"{",PUNCTx,"output",KEYx,
                "(",PUNCTx,"\"too high\"",STRLITx,",",PUNCTx,"eol",KEYx,
                ")",PUNCTx,";",PUNCTx,"}",PUNCTx,
              "else",KEYx,"{",PUNCTx,"output",KEYx,"(",PUNCTx,
                "\"too low\"",STRLITx,",",PUNCTx,"eol",KEYx,
                ")",PUNCTx,";",PUNCTx,"}",PUNCTx},
              "Short program, little whitespace")
    ...
    checkLex(t,
        ...
        "}\n",
             ...
             "{",PUNCTx,
              ...
              "output",KEYx,"(",PUNCTx,"\"Fibonacci Numbers\"", STRLITx,
                ",",PUNCTx,"eol",KEYx,")",PUNCTx,";",PUNCTx,
              ...
              "ff",IDx,"=",OPx,"fibo",IDx,"(",PUNCTx,")",PUNCTx,
                ";",PUNCTx,
              "output",KEYx,"(",PUNCTx,"\"F(\"",STRLITx,",",PUNCTx,
                "j",IDx,",",PUNCTx,"\") = \"",STRLITx,",",PUNCTx,
                "ff",IDx,",",PUNCTx,"eol",KEYx,")",PUNCTx,";",PUNCTx,
    ...
    checkLex(t, "if(not(true and false or 1)<2<=3>4>=5-6*7/8%9+a[3])"..
                "{abcdefg_12345=00000;"..
                "output(+123e45--987E+65,+abcdefg_12345);"..
                "}",
