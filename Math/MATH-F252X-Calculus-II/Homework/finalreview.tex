        ...
        \begin{mdframed}
            ...
            \begin{equation*}
                \begin{gathered}
                    ...
                    \text{Where } A = (16-x^{2})^{2} = 4x^{4}-32x^{2}+256   \\
                    \int_{-4}^{4}4x^{4}-32x^{2}+256dx = 2\left[\frac{4x^{5}}{5}-\frac{32x^{3}}{3}+256x\right]_{0}^{4} =
                    2\left[\frac{4x^{5}}{5}-\frac{32x^{3}}{3}+256x\right] = 
